...
describe("Custom OutputBuilder — tag name transformation", function () {
  ...
  runAcrossAllInputSourcesWithFactory(
    ...
    () => {
      class StripNsBuilder extends CompactBuilder {
        addElement(tag, matcher) {
  ...
  runAcrossAllInputSourcesWithFactory(
    ...
    () => {
      class SkipTagBuilder extends CompactBuilder {
        constructor(...args) {
          super(...args);
          this._skipDepth = 0;
        }
  ...
  runAcrossAllInputSourcesWithFactory(
    ...
    () => {
      class RenameOnCloseBuilder extends CompactBuilder {
        closeElement(matcher) {
...
describe("Custom OutputBuilder — attribute transformation", function () {
  ...
  runAcrossAllInputSourcesWithFactory(
    ...
    () => {
      class LowerCaseAttrBuilder extends CompactBuilder {
  ...
  runAcrossAllInputSourcesWithFactory(
    ...
    () => {
      class RenameAttrBuilder extends CompactBuilder {
        addAttribute(name, value) {
  ...
  runAcrossAllInputSourcesWithFactory(
    ...
    () => {
      class DropAttrBuilder extends CompactBuilder {
        addAttribute(name, value) {
  ...
  runAcrossAllInputSourcesWithFactory(
    ...
    () => {
      class DropXmlnsBuilder extends CompactBuilder {
        addAttribute(name, value) {
  ...
  runAcrossAllInputSourcesWithFactory(
    ...
    () => {
      class UpperCaseAttrValueBuilder extends CompactBuilder {
        addAttribute(name, value) {
  ...
  runAcrossAllInputSourcesWithFactory(
    ...
    () => {
      class NormaliseAttrsBuilder extends CompactBuilder {
        constructor(...args) {
          super(...args);
          this._pendingAttrs = {};
        }
...
describe("Custom OutputBuilder — combined tag and attribute transformation", function () {
  ...
  runAcrossAllInputSourcesWithFactory(
    ...
    () => {
      class LowerCaseAllBuilder extends CompactBuilder {
        addElement(tag, matcher) {
  ...
  runAcrossAllInputSourcesWithFactory(
    ...
    () => {
      class TagNameAttrBuilder extends CompactBuilder {
        addElement(tag, matcher) {
